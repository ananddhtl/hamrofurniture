                        ...
                        <form class="form-horizontal" action="{{ url('/stockitemstoredummy') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3  dropdown">
                                    ...
                                    <div>
                                        <input type="text" class="form-control dropbtn" autocomplete="off" onkeyup="selectProductsFromTable();" id="itemName" placeholder="Product" value="{{ @$dummydata[0]->itemName }}">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" readonly class="form-control " autocomplete="off" placeholder="Unit" id="itemUnits" name="Unit" value="{{ @$dummydata[0]->units }}">
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3">
                                    <input type="number" class="form-control" autocomplete="off" name="Rate" placeholder="Rate" value="{{ @$dummydata[0]->rate }}">
                                </div>
                            ...
                            <div class="col">
                                ...
                                <a href="/stockin"><button type="button" class="btn btn-default">
                                        Clear
                                    </button></a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/stockindelete/{{ $item->id }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item ?');"> Delete
                            </a>
                ...
                <div class="widget-shadow " data-example-id="basic-forms">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" readonly="" autocomplete="off" class="form-control" name="vatable" placeholder="Vatable" value="Auto" readonly>
...
<script>
    function putDate() {
        document.getElementById("saveStockATag").href = "stockin/save/" + document.getElementById("transactionDate").value;
    }
