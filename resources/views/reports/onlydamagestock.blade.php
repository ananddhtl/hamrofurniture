        ...
        <div class="form-body">
            ...
            <span>
                <form class="form-inline" action="{{ url('/searchoutstockdate') }}" method="GET">
                    @csrf
                    <div class="form-group"> <input  name="search" class="form-control" placeholder="Search"> </div>
        ...
        <div data-example-id="simple-form-inline" class="inform">
            <div>
                ...
                <form class="form-inline" action="{{url('/SearchItemBetweenDateoutstock')}}" method="GET">
                    ...
                    <span class="form-group"> <input type="date" name="search2" class="form-control" value="<?php echo $mytime->toDateString("dd/MM/yyyy"); ?>" placeholder="Search"> </span>
