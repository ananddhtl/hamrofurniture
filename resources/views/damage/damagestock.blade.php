        ...
        <div class="forms">
            <div class=" form-grids row form-grids-right">
                <div class="widget-shadow " data-example-id="basic-forms">
                    ...
                    <div class="form-body">
                        <form class="form-horizontal" action="{{ url('/damageitemstoredummythree') }}" method="POST">
                            @csrf
            ...
            <table class="table" id="displaySearchItems">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/damage/{{ $item->id }}" class="btn btn-info">Edit </a>
                            <a href="/damagedelete/{{ $item->id }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item ?');"> Delete
                            </a>
                ...
                <div class="widget-shadow " data-example-id="basic-forms">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 ">
                                <a href="/damage/save/<?php echo $mytime->toDateString(); ?>" id="saveStockATag"> <button type="submit" class="btn btn-info">Save
                                    </button></a>
                            </div>
                            <br>
                        </div>
        ...
        <!-- <div class="inline-form widget-shadow">
            <div class="form-body text-right">
                <div data-example-id="simple-form-inline">
                    <a href="/damage/save/<?php echo $mytime->toDateString(); ?>" id="saveStockATag"> <button type="submit" class="btn btn-default">Save
                        </button></a>
                </div>
            </div>
        </div> -->
