...
<head>
	<title>e-Godam Inventory System :: Tukisoft Pvt.Ltd.</title>
	...
	<link href="{{ asset('web/css/dropdown.css') }}" rel="stylesheet">
	<!--//Metis Menu -->
	<style>
		#chartdiv {
			width: 100%;
	...
	<script src="{{ asset('web/js/pie-chart.js') }}" type="text/javascript"></script>
